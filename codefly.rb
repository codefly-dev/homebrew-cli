...
class Codefly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/codefly-dev/cli-releases/releases/download/v0.0.47/codefly-darwin-arm64"
    end
    if Hardware::CPU.intel?
      url  "https://github.com/codefly-dev/cli-releases/releases/download/v0.0.47/codefly-darwin-amd64"
    end
